...
export const DATABASE_CONFIG = {
  ...
  PAYMENTS_COLLECTION_ID: process.env.EXPO_PUBLIC_APPWRITE_PAYMENTS_COLLECTION_ID || 'payments',
  TRANSACTIONS_COLLECTION_ID: process.env.EXPO_PUBLIC_APPWRITE_TRANSACTIONS_COLLECTION_ID || 'transactions'
}
