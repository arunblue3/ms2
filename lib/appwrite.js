...
export const DATABASE_CONFIG = {
  ...
  PAYMENTS_COLLECTION_ID: process.env.EXPO_PUBLIC_APPWRITE_PAYMENTS_COLLECTION_ID || '68854198001f455b23cf',
  TRANSACTIONS_COLLECTION_ID: process.env.EXPO_PUBLIC_APPWRITE_TRANSACTIONS_COLLECTION_ID || '688541a20027e0197b27'
}

// Stripe configuration
export const STRIPE_CONFIG = {
  PUBLISHABLE_KEY: process.env.EXPO_PUBLIC_STRIPE_PUBLISHABLE_KEY || '',
  PAYMENT_FUNCTION_URL: process.env.EXPO_PUBLIC_APPWRITE_ENDPOINT + '/functions/stripe-payment/executions',
  WEBHOOK_FUNCTION_URL: process.env.EXPO_PUBLIC_APPWRITE_ENDPOINT + '/functions/stripe-webhook/executions'
}
